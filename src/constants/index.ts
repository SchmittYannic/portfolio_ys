...
const projects: ProjectType[] = [
    ...
    {
        title_de: "Admin-Dashboard",
        title_en: "Admin dashboard",
        image: hairdresserDashboardAppimg,
        webm: hairdresserDashboardApp,
        mode: "light",
        demoaccname: "admin1@demo.com",
        demoaccpw: "Admin#1",
        description_de: [
            "Das Projekt umfasst ein Admin-Dashboard für die Terminbuchungsapplikation eines fiktiven Friseursalons und befindet sich aktuell in aktiver Entwicklung. Die Anwendung richtet sich an Mitarbeitende des Salons und ermöglicht ihnen die Einsicht und Verwaltung gebuchter Termine.",
            "Die Applikation verfügt über eine tokenbasierte Authentifizierung mit geschütztem Zugang für autorisierte Nutzer. Nach dem Login gelangen Mitarbeitende auf ein zentrales Dashboard, das eine Übersicht über aktuelle Buchungen und weitere relevante Informationen bietet.",
            "Ein integrierter Kalender erlaubt die Ansicht der Termine in verschiedenen Modi – Tag, Woche und Monat – und erleichtert so die tägliche Planung. Darüber hinaus steht eine Kundentabelle zur Verfügung, die Sortierung, Paginierung und Filterung der Einträge ermöglicht, um schnell auf relevante Informationen zugreifen zu können.",
            "Geplante zukünftige Funktionalitäten beinhalten die Möglichkeit für Mitarbeitende, ihre tägliche Arbeitszeit inklusive Pausen eigenständig zu verwalten sowie Abwesenheiten wie Krankheit oder Urlaub zu erfassen. Zusätzlich sollen Termine auch manuell für Kund:innen eingetragen werden können, die die Online-Buchungsanwendung nicht nutzen. Die Bearbeitung und Pflege von Kundeninformationen wird ebenfalls ermöglicht.",
            "Darüber hinaus ist vorgesehen, den Mitarbeitenden erweiterte Informationen zu den Kund:innen bereitzustellen – darunter bevorzugte Dienstleistungen, Besuchsintervalle sowie Auslastungsstatistiken in Form verfügbarer oder belegter Terminslots. Ziel ist es, interne Abläufe effizienter zu gestalten und gleichzeitig eine personalisierte Kundenbetreuung zu unterstützen.",
        ],
        description_en: [
            "The project consists of an admin dashboard for the appointment booking application of a fictional hair salon and is currently under active development. The application is intended for salon staff and allows them to view and manage booked appointments.",
            "The application features token-based authentication, providing secure access for authorized users. After logging in, staff are directed to a central dashboard that offers an overview of current bookings and other relevant information.",
            "An integrated calendar allows users to view appointments in different modes – day, week, and month – making daily planning easier. Additionally, a customer table is available, offering sorting, pagination, and filtering functionalities to quickly access relevant data.",
            "Planned future features include the ability for staff to manage their own working hours and breaks, as well as to record absences such as sick leave or vacation. Appointments will also be able to be entered manually for clients who do not use the online booking app. Editing and maintaining customer data will also be possible.",
            "Moreover, the dashboard is intended to provide staff with extended information about clients – including preferred services, visit frequency, and utilization statistics such as how many appointment slots remain open. The goal is to streamline internal processes while supporting a more personalized customer experience.",
        ],
