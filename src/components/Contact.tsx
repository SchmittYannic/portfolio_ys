...
const Contact = () => {
    ...
    const myLinkedIn = String(import.meta.env.VITE_PERSONAL_LINKEDIN);
    ...
    return (
        <section
            id="contact"
            className={`relative w-full lg:py-32 md:py-24 py-12 border-t-2 border-gray-100 dark:border-gray-800 overflow-hidden`}
        >
            <div
                    ...
                    >
                        ...
                        >
                            ...
                            <a
                                ...
                                target="_blank"
                            >
                                /in/{myLastname.toLowerCase()}-{myFirstname.toLowerCase()}/
                            </a>
                        </div>
                    </div>
                </div>
