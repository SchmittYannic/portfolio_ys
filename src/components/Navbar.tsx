...
const DesktopNav = () => {
    ...
    return (
        <>
            ...
            <div className={`${isSettingOpen ? "visible opacity-100" : "invisible opacity-0"} absolute top-[calc(1rem+50px)] left-0 rounded-lg bg-baseSecondary divide-y divide-base shadow-xl ml-6 mt-6 z-10`}>
